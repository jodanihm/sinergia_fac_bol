...
if (count($args) !== 2) fail("Uso: php scripts/emitir_nc_caso6.php <ambiente> <rut_emisor>");
...
// Ítems devueltos (mismos precios y descuentos que factura 33)
$detallesDev = [
    new Detalle('Pañuelo AFECTO', 76, 1723, descuentoPorcentaje: 3.0),
    new Detalle('ITEM 2 AFECTO', 90, 787, descuentoPorcentaje: 4.0),
];
...
$nc = new DocumentoTributario(
    ...
    observaciones: 'DEVOLUCION DE MERCADERIAS',
    referencias: [[
        'tipoDocumento' => '33',
        'folio' => 33,
        'fecha' => '2026-06-19',
        'codigo' => '3', // Corrige monto
        'razon' => 'DEVOLUCION DE MERCADERIAS',
    ]],
);

// Montos de la factura 33 (Caso 2): neto 379211, IVA 72050, total 451261 (aproximado)
$original = new DocumentoOriginal(
    ...
    receptor: $receptor,
    detalles: [
        new Detalle('Pañuelo AFECTO', 208, 1723, descuentoPorcentaje: 3.0),
        new Detalle('ITEM 2 AFECTO', 133, 787, descuentoPorcentaje: 4.0),
    ],
    montoNeto: 379211,
    iva: 72050,
    montoTotal: 451261,
...
echo "*** CASO 6 - NC Devolución Parcial (ref. factura folio 33) ***\n";
try {
    $resultado = $facturador->emitirDocumentoReferenciado($nc, $original, TipoAnulacion::CorrigeMonto, $cred);
